...
//      public ArrayList<Pencil> cup = new ArrayList();
...
//		}
//
	//	healthpotion = new Item(550, 800);
//		healthpotion1 = new Item(600, 800);
//                stormy = new Ninja(0,0);
//                daniel = new Ninja(124,254);
//                pen = new Pencil(0,0);
//                cil = new Pencil(124,254);
...
//                flav = new Enemy(256,256);
	...
	//	speedpotion = new Item1(550,700);
//		speedpotion1 = new Item1(600,700);	
...
//                bonez.add(flava);
//                bonez.add(flav);
		//antidote = new Itemwin(550,600);
//                antidote = new Itemwin(600,600);
